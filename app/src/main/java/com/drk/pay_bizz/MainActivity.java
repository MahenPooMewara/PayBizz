...
public class MainActivity extends AppCompatActivity {
    ...
    String ImageUploadPathOnSever =
            "https://androidjsonblog.000webhostapp.com/capture_img_upload_to_server.php";
    ...
    public void EnableRuntimePermissionToAccessCamera() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(MainActivity.this,
            ...
            Toast.makeText(MainActivity.this,
                    "CAMERA permission allows us to Access CAMERA app", Toast.LENGTH_LONG).show();
    ...
    public void ImageUploadToServerFunction() {
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String FinalData = imageProcessClass.ImageHttpRequest(ImageUploadPathOnSever,
                        HashMapParams);
        ...
        public String ImageHttpRequest(String requestURL, HashMap<String, String> PData) {
            ...
            try {
                ...
                if (RC == HttpsURLConnection.HTTP_OK) {
                    ...
                    bufferedReaderObject = new BufferedReader(new InputStreamReader(
                            httpURLConnectionObject.getInputStream()));
