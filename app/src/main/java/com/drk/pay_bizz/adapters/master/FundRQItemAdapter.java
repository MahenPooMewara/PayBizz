package com.drk.pay_bizz.adapters.master;
 ...
 */
public class FundRQItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final FundRQItemAdapter.OnItemClickListener mListener;
     ...
     * @param mListener
     */
    public FundRQItemAdapter(List<Object> items, Activity activity, OnItemClickListener mListener) {
        this.mItems = items;
