 ...
 */
public class PayUItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final PayUItemAdapter.OnItemClickListener mListener;
     ...
     * @param mListener
     */
    public PayUItemAdapter(List<Object> items, Activity activity, OnItemClickListener mListener) {
        this.mItems = items;
